        ...
        <div class="product-container">
          <?php foreach($produtos as $produto) : ?>
            <div class="product-image-container">
                <img src="<?= $produto->imagem ?>" alt="Vultures shirt" class="product-image">
            </div>
            <div class="product-data">
                  <h2 class="span-data"><?= $produto->nome ?></h2>
                  <span class="span-data">R$ <?= $produto->preco ?></span>
                  <span class="span-data">Categoria: <?= $produto->categoria ?></span>
                  <span class="span-data">Vendedor: <?= $produto->vendedor ?></span>
                  <p class="text-data">Descrição: <?= $produto->descricao ?></p>
                  <form action="./compra.php" method="POST">
                    <input type="hidden" name="idProduto" value="<?= $produto->id ?>">
                    <label for="quant" class="label-quantity">Quantidade:</label>
                    <input type="number" name="quant" id="quant" min="1" max="10" value="1" class="input-quantity"/> <br>
                    <input type="submit" value="Colocar no carrinho" class="buy-button" style="width: 100%; margin-top: 20px;"/>
                  </form>
              </div>
            <?php endforeach; ?>
        </div>
